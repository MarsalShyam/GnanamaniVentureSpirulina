...
export default function FooterSection() {
  return (
    <footer className="w-full bg-[var(--primary-green)] text-white pt-16 pb-6 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-12">
        ...
        <div>
          ...
          <p className="text-sm text-gray-200">123, Green Valley Industrial Park<br />Chennai, India - 600001</p>
          <p className="mt-2 text-sm text-gray-200">Phone: +91 98765 43210</p>
          <p className="mt-1 text-sm text-gray-200">Email: info@spirulinapure.com</p>
